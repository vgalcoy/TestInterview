<div class="footer">
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">Galih Pangestu</span>
		...
		<script type="text/javascript" src="<?php echo base_url('assets/js/jquery.flot.resize.min.js');?>"></script>
  		...
  		<script type="text/javascript" src="<?php echo base_url('assets/mencoba/js/bootstrap.min.js');?>"></script>
 		<script type="text/javascript" src="<?php echo base_url('assets/mencoba/js/bootstrap-multiselect.js');?>"></script>
 		<script type="text/javascript" src="<?php echo base_url('assets/mencoba/js/main.js');?>"></script>
		<!-- ace scripts -->
